...
class CSIPersistentVolumeSource(BaseModel):
    ...
    volumeAttributes: Optional[Dict[str, VolumeAttributes]] = Field(
...
class LimitRangeItem(BaseModel):
    ...
    defaultRequest: Optional[Dict[str, DefaultRequest]] = Field(
        None,
    ...
    maxLimitRequestRatio: Optional[Dict[str, MaxLimitRequestRatio]] = Field(
        None,
...
class ConfigMap(BaseModel):
    ...
    binaryData: Optional[Dict[str, BinaryData]] = Field(
        None,
...
class Secret(BaseModel):
    ...
    stringData: Optional[Dict[str, StringData]] = Field(
        None,
...
class PodSpec(BaseModel):
    ...
    nodeSelector: Optional[Dict[str, NodeSelector]] = Field(
        None,
